<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="agentList" @selection-change="handleSelectionChange"  >
      ...
      <el-table-column label="ID" align="center" prop="id"  sortable @default-sort = "ascending" /> 
      <el-table-column label="排序" align="center" prop="sort"  sortable @default-sort = "descending"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label=" 推广人"   prop="belongAgentNo">
          <el-input v-model="form.belongAgentNo" placeholder="请输入所属代理商编号" />
        </el-form-item>
        <el-form-item label="公司名称" :rules="rules" prop="companyName">
